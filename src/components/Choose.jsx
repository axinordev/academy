...
const Choose = () => {
  return (
    <section className="py-12 bg-[#F0FFFF]">
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-8">

          {/* Left Image with overlay */}
          <div className="lg:w-1/2 relative mb-8 lg:mb-0 p-4 lg:pl-0 lg:pt-14 order-2 lg:order-1">
            <img 
              src={Image1} 
              alt="image1" 
              className="rounded-3xl shadow-lg max-w-full h-auto relative z-10"
            />
            {/* Overlay image2 */}
            <img 
              src={Image2} 
              alt="decorative" 
              className="absolute -top-6 -left-6 w-32 h-32 z-20"
            />
          </div>
          ...
          <div className="lg:w-1/2 flex flex-col gap-6 order-1 lg:order-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-[#F0FFFF] rounded-3xl shadow-md p-5 text-center hover:shadow-lg transition">
